          ...
          <div>
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Explore near real-time exchange rates from top banks in Sri
                Lanka, effortlessly compare their offerings, and unleash the
                power of our intuitive currency converter for seamless
                calculations, all on lkr.exchange!
              </p>
            </div>
          </div>
